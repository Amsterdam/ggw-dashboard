            ...
            <Column span={12}>
              <div>
                <FooterSection title="Colofon?">
                  <p>
                    Gebied in Beeld is gemaakt door OIS in opdracht van de samenwerkende stadsdelen.
                    <br />
                ...
                <FooterSection title="Disclaimer">
                  <p>
                    ...
                    worden gesteld voor eventuele schade of consequenties ontstaan door direct of indirect gebruik van
                    de inhoud van de website.
                  </p>
                  <p>
                    Alle informatie op Gebied in Beeld valt onder Copyright &copy; van OIS, tenzij een andere bron is
                    vermeld.
                    <br />
